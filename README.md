  ...
  <div class="panel shop-panel">
    ...
    <div class="shop-section" id="tab-special">
      ...
      <div class="potion-card" id="potion-poison-card">
        ...
        <div class="potion-desc">Poison the enemy at the start of combat — they take <strong style="color:#a78bfa">15 extra damage</strong> every turn for the rest of the match. One use per fight.</div>
...
function enemyTurn() {
  ...
  f.playerStamina = Math.min(f.playerMaxStamina, f.playerStamina + 9 + Math.floor(state.skills.stamina * 1.25));
  // Venom of Spite: +15 poison damage per turn
  if (potionState.poison.activeThisFight) {
    currentEnemy.hp = Math.max(0, currentEnemy.hp - 15);
    addLog(`🧪 <span style="color:#a78bfa">Poison deals 15 damage to ${currentEnemy.name}! (${currentEnemy.hp} HP left)</span>`, 'system');
...
function activatePotions() {
  ...
  if (potionState.poison.owned) {
    ...
    addLog(`🧪 <span style="color:#a78bfa">Venom of Spite applied! Enemy takes +15 damage per turn.</span>`, 'system');
  }
